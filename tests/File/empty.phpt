...
File::$default_fs_encoding = '';
$root = dirname(dirname(__DIR__)) . '/tmp/empty_test';
...
?>
--EXPECTF--
string(%d) "%s/tmp/empty_test/test"
string(%d) "%s/tmp/empty_test/test"
string(%d) "%s/tmp/empty_test"
string(18) "测试文件内容"
测试文件内容
[{"name":"test","dir":false}]
[]
